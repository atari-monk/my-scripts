...
class TestDocsIndexGen:
    ...
    def test_init_with_valid_path(self, temp_repo_path, mock_logger):
        generator = DocsIndexGen(temp_repo_path, mock_logger)
    ...
    def test_init_with_invalid_path_raises_filenotfounderror(self, mock_logger):
        with pytest.raises(FileNotFoundError):
            DocsIndexGen("/nonexistent/path", mock_logger)
    ...
    def test_init_with_file_path_raises_notadirectoryerror(self, temp_repo_path, mock_logger):
        ...
        with pytest.raises(NotADirectoryError):
            DocsIndexGen(file_path, mock_logger)

    def test_clean_name(self):
        assert DocsIndexGen.clean_name("test_name") == "Test Name"
        assert DocsIndexGen.clean_name("test-name") == "Test Name"
        assert DocsIndexGen.clean_name("  test_name  ") == "Test Name"
        assert DocsIndexGen.clean_name("TEST_NAME") == "Test Name"
