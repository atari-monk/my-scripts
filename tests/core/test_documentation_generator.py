...
class TestDocumentationGenerator:
    ...
    def test_init_with_valid_path(self, temp_repo_path, mock_logger):
        generator = DocumentationGenerator(temp_repo_path, mock_logger)
    ...
    def test_init_with_invalid_path_raises_filenotfounderror(self, mock_logger):
        with pytest.raises(FileNotFoundError):
            DocumentationGenerator("/nonexistent/path", mock_logger)
    ...
    def test_init_with_file_path_raises_notadirectoryerror(self, temp_repo_path, mock_logger):
        ...
        with pytest.raises(NotADirectoryError):
            DocumentationGenerator(file_path, mock_logger)

    def test_clean_name(self):
        assert DocumentationGenerator.clean_name("test_name") == "Test Name"
        assert DocumentationGenerator.clean_name("test-name") == "Test Name"
        assert DocumentationGenerator.clean_name("  test_name  ") == "Test Name"
        assert DocumentationGenerator.clean_name("TEST_NAME") == "Test Name"
    ...
    def test_generate_index_content_with_files_in_root(self, temp_repo_path, mock_logger):
        ...
        assert content == ["\n## Documentation Index", "- [Test](test.md)"]
